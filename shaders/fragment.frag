...
const float MATERIAL_SHININES = 0.8;
const vec4 Global_ambient = vec4(0.05, 0.04, 0.08, 1);
...
void main() {
    ...
    vec3 mat_color = texture2DRect(colorMap,   gl_FragCoord.xy).xyz;
    ...
    vec4 fragColor = Global_ambient * color;
